...
public interface AlumnoRepository extends JpaRepository<Alumno, Long> {
    ...
    @Query("SELECT new org.tpe_entrega_3.dtos.AlumnoDTO(a.nombre, a.apellido, a.edad, a.genero, a.dni, a.ciudad, a.legajo, e.carrera.nombre) FROM Alumno a JOIN a.carreras e WHERE e.carrera.nombre = :carrera AND a.ciudad = :ciudad")
